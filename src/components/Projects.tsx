...
export function Projects() {
  return (
    <div className="projects">
      ...
      <h1 className="text-center text-violet-500 bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-pink-500 items-start font-bold text-3xl  py-2 mt-20 mb-5 sm:mt-15">Projetos</h1>
